...
const PersonMiddleware_1 = __importDefault(require("../middleware/PersonMiddleware"));
const express_1 = require("express");
const router = (0, express_1.Router)();
const dataSource = DataSource_1.AppDataSource;
const personController = new PersonController_1.default(dataSource);
router.post('/', PersonMiddleware_1.default.PersonValidator, (req, res) => personController.createPerson(req, res));
