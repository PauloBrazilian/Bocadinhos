...
const ProductMiddleware_1 = __importDefault(require("../middleware/ProductMiddleware"));
const router = (0, express_1.Router)();
const dataSource = DataSource_1.AppDataSource;
const productsController = new ProductController_1.default(dataSource);
router.post('/', ProductMiddleware_1.default.productValidate, (req, res) => productsController.createProduct(req, res));
